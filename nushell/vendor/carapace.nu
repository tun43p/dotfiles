...
export-env {
  $env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/tun43p/Library/Application Support/carapace/bin" } | prepend "/Users/tun43p/Library/Application Support/carapace/bin")
}
